...
-   deactivate users to retain their metadata
-   bulk delete multiple users from a database to delete users and their metadata

Users metadata may be required for auditing purposes in which case the user may be deactivated.

On the other hand, if the user access and their metadata should be removed, the user may be deleted from the database altogether.
...
### Example of how to bulk invite multiple users

EXAMPLE1: you wish to add multiple new users in your database. Description: in this example we have saved the users' names and emails in a csv file named "Users". We will import this csv file in R
