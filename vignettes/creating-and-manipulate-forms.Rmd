...
vignette: >
  %\VignetteIndexEntry{Create and manipulate databases and forms using R}
...
Creating a new form is also possible in R in three steps:
1. Create a form schema with `formSchema(databaseId, label, elements, folderId)`
