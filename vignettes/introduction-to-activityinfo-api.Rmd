...
In order to access to the *ActivityInfo API*, an authentication process has 
first to be done. One must setup a personal access token using the ActivityInfo
dashboard. Logging in by email and password through the API is now deprecated
and insecure.
...
as it contains your personal access token.
...
[Formulas Manual](https://www.activityinfo.org/support/docs/m/77022/index.html).
